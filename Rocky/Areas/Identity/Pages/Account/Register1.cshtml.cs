...
namespace Rocky.Areas.Identity.Pages.Account1
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        {
            if (!await _roleManager.RoleExistsAsync(WC.SalesDepartment))
            {
                await _roleManager.CreateAsync(new IdentityRole(WC.SalesDepartment));
                await _roleManager.CreateAsync(new IdentityRole(WC.WorkWarehouse));
            }
            ReturnUrl = returnUrl;
